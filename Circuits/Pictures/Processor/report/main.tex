...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figs_abhimanyu/ALU.png}
    \caption{ALU Block}
    \label{fig:alu}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figs_abhimanyu/Addsub.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figs_abhimanyu/ShiftLeft_nbits.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figs_abhimanyu/Shiftright_nbits.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figs_abhimanyu/Unsigned_multiplier.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figs_abhimanyu/Unsigned_divider.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figs_abhimanyu/data_memory.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\textwidth]{FPU/figs/fpadder.png}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.5\textwidth]{FPU/figs/fpadder_tb.png}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\textwidth]{FPU/figs/fpmul.png}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\textwidth]{FPU/figs/fpmul_tb.png}
\end{figure}
As mentioned above and observed in the test-bench, issues only arise due to rounding, it will be fixed soon.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.4\textwidth]{FPU/figs/dig.png}
\end{figure}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth]{FPU/figs/fsqrt_tb.png}
\end{figure}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=1.2\textwidth]{FPU/figs/fcvtld.png}
        \caption{fcvt.l.d test bench}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=1.2\textwidth]{FPU/figs/fcvtdl.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/datapath.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/R-Format.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/I-format_wo_load_jalr.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/load.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/jalr.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/B-format.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/J-format.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/S-format.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/lui.png}
...
\begin{figure}[H]
    \flushleft
    \includegraphics[width=1.2\linewidth]{figs_abhimanyu/auipc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figs_agam/zynq.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figs_agam/zynqbd.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figs_agam/corebd.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figs_agam/axidatabram.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figs_agam/axiinstrbram.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figs_agam/axirst.png}
\end{figure}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_agam/memorymap.png}
\end{figure}


\part{Testing --- WORK IN PROGRESS ---}
PLEASE NOTE: this is A WORK IN PROGRESS and the images have not been uploaded yet. This will be changed in the final report.
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/alu_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{figs_agam/verifyalu1.png}
    \end{figure}
This shows and verifies the working of ALU for basic \textbf{add, sub, mul, div} operations.
\subsection{Logical Operations}
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/alu_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_sim_1.png}
    \end{figure}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/alu_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_sim_1.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/alu_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_sim_1.png}
...
\begin{enumerate}
    \item \textbf{Addition-Subtraction : Double} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_sim_1.png}
    ...
    \item \textbf{Addition-Subtraction : Double (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_sim_2.png}
    \end{figure}
    ...
    \item \textbf{Addition-Subtraction : Single} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_inhouse_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_sim_3.png}
    \end{figure}
    \item \textbf{Addition-Subtraction : Single (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_inhouse_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fadd_sim_4.png}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{Multiplication-Division : Double} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_sim_1.png}
    \end{figure}
    \item \textbf{Multiplication-Division : Double (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_sim_2.png}
    \end{figure}
    ...
    \item \textbf{Multiplication-Division : Single} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_inhouse_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_sim_3.png}
    \end{figure}
    \item \textbf{Multiplication-Division : Single (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_inhouse_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmul_sim_4.png}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{Square Root: Double (with edge cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsqrt_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsqrt_sim_1.png}
    \end{figure}
   ...
   \begin{table}[h]
    ...
    \item \textbf{Square Root: Double (with edge cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsqrt_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsqrt_sim_2.png}
    \end{figure}
    Trying to take square root of either a \textbf{NaN} or a negative number will return \textbf{NaN} as the result. Similarly, taking square root of $+\infty$ will return $+\infty$. As fast inverse square root has been used to approximate square root for faster calculation, there is some mismatch in simulator and obtained values. The percent error comes out to be around $5\%$.
   \begin{table}[h]
        \centering
...
\begin{enumerate}
    \item \textbf{Min-Double} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_sim_1.png}
    \end{figure}
    \item \textbf{Min-Double (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_sim_2.png}
    \end{figure}
    ...
    \item \textbf{Min-Single} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_inhouse_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_sim_3.png}
    \end{figure}
    \item \textbf{Min-Single (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_inhouse_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmin_sim_4.png}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{feq flt fle: Double} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_sim_1.png}
    \end{figure}
    \item \textbf{feq flt fle: Double (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_sim_2.png}
    \end{figure}
    ...
    \item \textbf{feq flt fle: Single} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_inhouse_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_sim_3.png}
    \end{figure}
    \item \textbf{feq flt fle: Single (Edge Cases)} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_inhouse_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/feq_sim_4.png}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{fsgnj fsgnjn fsgnjx: Double}\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_sim_1.png}
    \end{figure}
    \item \textbf{fsgnj fsgnjn fsgnjx: Double (Edge Cases)}\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_sim_2.png}
    \end{figure}
    ...
    \item \textbf{fsgnj fsgnjn fsgnjx: Single}\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_inhouse_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_sim_3.png}
    \end{figure}
    \item \textbf{fsgnj fsgnjn fsgnjx: Single (Edge Cases)}\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_inhouse_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fsgnj_sim_4.png}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{GPR to FPR}\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_sim_1.png}
    \end{figure}
    \item \textbf{FPR to GPR} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_sim_2.png}
    \end{figure}
    \item \textbf{GPR to FPR}\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_inhouse_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_sim_3.png}
    \end{figure}
    \item \textbf{FPR to GPR} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_inhouse_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fmv_sim_4.png}
    \end{figure}
...
\begin{enumerate}
    \item \textbf{Long Word - Double} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_inhouse_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_1.png}
    \end{figure}
    \item \textbf{Double - Long Word} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_inhouse_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_2.png}
    \end{figure}
    \item \textbf{Double - Long Word} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_inhouse_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_3.png}
    \end{figure}
    ...
    \item \textbf{Word-Single} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_inhouse_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_4.png}
    \end{figure}
    \item \textbf{Single-Double} \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_5.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_5.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_abhimanyu/branch_test.png}
    \end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figs_abhimanyu/branch_mem.png}
\end{figure}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_abhimanyu/jump_test.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figs_abhimanyu/jump_mem.png}
\end{figure}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_abhimanyu/U_jalr_test.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figs_abhimanyu/U_jalr_mem.png}
\end{figure}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/store_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_5.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/data_hazard_1.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_5.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/data_hazard_2.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_5.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/data_hazard_3.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_5.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/data_hazard_4.png}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{figs_arjun/fcvt_sim_5.png}
